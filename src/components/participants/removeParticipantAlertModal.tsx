  ...
  const renderButtons = () => {
    return (
      <Fragment>
        ...
        <button
          type="button"
          className="h-10 px-5 w-32 flex items-center justify-center text-sm 3xl:text-base font-semibold bg-primary-color hover:bg-white border border-[#0088CC] rounded-[15px] text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow cursor-pointer ml-4"
