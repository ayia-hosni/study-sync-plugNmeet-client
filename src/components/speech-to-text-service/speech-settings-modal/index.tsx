  ...
  return (
    ...
    >
      ...
      <div className="bottom-area pt-4 mt-4 text-Gray-950 border-t border-Gray-100 flex justify-end gap-5 -mx-4 px-4">
        <button
          className="h-10 px-8 w-1/2 cursor-pointer text-sm 3xl:text-base font-semibold bg-primary-color hover:bg-white border border-[#0088CC] rounded-[15px] text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow"
