...
const TranscriptionSettingsModal = () => {
  ...
  const renderButtons = () => (
    ...
    >
      ...
      {!speechService?.isEnabled && (
        <button
          className="h-10 px-8 w-full cursor-pointer text-sm 3xl:text-base font-semibold bg-primary-color hover:bg-white border border-[#0088CC] rounded-[15px] text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow"
      ...
      {speechService?.isEnabled && (
        <>
          <button
            className="order-3 h-10 px-8 w-full cursor-pointer text-sm 3xl:text-base font-semibold bg-primary-color hover:bg-white border border-[#0088CC] rounded-[15px] text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow"
            onClick={() => enableOrUpdateService()}
          >
