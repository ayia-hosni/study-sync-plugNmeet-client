        ...
        <div className="flex min-h-full items-center justify-center py-4">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 px-4 py-4 border-t border-Gray-100">
              ...
              <button
                className="h-9 w-full flex items-center justify-center rounded-xl text-sm font-medium 3xl:font-semibold text-white bg-primary-color2-500 border border-Blue2-600 transition-all duration-300 hover:bg-primary-color2-600  shadow-button-shadow cursor-pointer"
                onClick={() => {
