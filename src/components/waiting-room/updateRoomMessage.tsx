  ...
  return (
    <div className="text-right">
      ...
      <button
        ...
        className="h-9 ml-auto cursor-pointer mt-2 px-5 text-sm font-medium bg-primary-color hover:bg-white border border-[#0088CC] rounded-[15px] text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow"
      >
