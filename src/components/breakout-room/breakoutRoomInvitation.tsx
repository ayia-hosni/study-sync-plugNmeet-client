            ...
            <div className="inline-block w-max h-full bg-white border border-Gray-200 shadow-virtualPOP p-4 rounded-xl overflow-hidden duration-300 ease-out">
              ...
              <div className="mt-2">
                ...
                {joinLink !== '' && (
                  <div className="invite-link mt-2">
                    ...
                    <div className="wrap flex items-center gap-1">
                      ...
                      <button
                        onClick={copyUrl}
                        className="h-7 ml-auto px-5 cursor-pointer text-sm font-medium bg-primary-color hover:bg-white border border-[#0088CC] rounded-[15px] text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow"
                      >
                        {copyText}
                      </button>
                    </div>
                ...
                <div className="button-section flex items-center justify-start mt-4">
                  <button
                    className="h-7 ml-auto px-5 cursor-pointer text-sm font-medium bg-primary-color hover:bg-white border border-[#0088CC] rounded-[15px] text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow disabled:opacity-50 disabled:cursor-not-allowed"
                    onClick={join}
                    disabled={isLoading}
                  >
