            ...
            <li key={user.id} className="flex items-center gap-2 text-sm">
              ...
              {!user.joined && (
                <button
                  ...
                  className="ml-auto h-6 px-3 cursor-pointer text-xs font-semibold bg-primary-color hover:bg-white border border-[#0088CC] rounded-[15px] text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow"
                >
