  ...
  return (
    <div className="manage-breakout-room-wrap">
      ...
      <div className="btn pb-3 pt-4 flex items-end justify-end">
        <button
          className="h-9 ml-auto px-5 cursor-pointer text-sm font-medium bg-primary-color hover:bg-white border border-[#0088CC] rounded-[15px] text-white hover:text-Gray-950 transition-all duration-300 shadow-button-shadow"
