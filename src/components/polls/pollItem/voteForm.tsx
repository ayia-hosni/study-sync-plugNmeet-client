      ...
      elms.push(
        ...
        >
          <input
            ...
            readOnly
            className="polls-checkbox relative appearance-none w-[18px] h-[18px] border border-Gray-300 shadow-button-shadow rounded-[6px] checked:bg-primary-color2-500 checked:border-Blue2-600"
          />
          <label
    ...
    >
      ...
      {!isRunning || voted || !selectedOption ? null : (
        <div className="button-section flex items-center justify-end mt-3">
          <button
            className="h-8 px-5 cursor-pointer flex items-center justify-center rounded-[10px] text-sm 3xl:text-base font-medium 3xl:font-semibold text-white bg-primary-color border border-DarkBlue transition-all duration-300 hover:bg-DarkBlue shadow-button-shadow"
            type="submit"
          >
            {t('polls.submit')}
          </button>
